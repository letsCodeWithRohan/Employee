...
<body class="font-[Poppins] overflow-x-hidden">
    <main class="h-[100vh] w-screen bg-gradient-to-r from-fuchsia-500 to-cyan-500 flex items-center justify-center">
        <form action="" method="post" class="w-[30%] bg-white rounded-md p-4">
            <h1 class="text-center font-bold text-3xl font-[Outfit] my-3 bg-gradient-to-r from-cyan-400 to-fuchsia-600 bg-clip-text text-transparent">Login</h1>
